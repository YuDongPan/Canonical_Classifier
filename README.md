# Introduction
This repository is provided for replicating the canonical recognition methods of SSVEP signals. The replicated methods include CCA [1], FBCCA [2], and TRCA [3]. 
The file distribution follow the code desgin of <a href="https://github.com/YuDongPan/SSVEPNet">SSVEPNet</a> [4]. And a 12-class public dataset [5] was used to conduct evaluation.
